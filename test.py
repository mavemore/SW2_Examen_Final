...
class Test(unittest.TestCase):
	...
	def test_cotizador_5(self):
		valor = cotizador.cotizar_seguro('Guayaquil','50', 'mujer','soltero','osteoporosis','0')
	...
	def test_cotizador_11(self):
		valor = cotizador.cotizar_seguro('Guayaquil','65', 'hombre','viudo','infarto','0')
		self.assertEqual(valor,30)
