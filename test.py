...
class Test(unittest.TestCase):
    ...
    def test_cotizador_1(self):
        cotizado = src.cotizador.cotizar_seguro('Machala', 29, 'mujer', 'soltero', 'infarto', 0)
    ...
    def test_cotizador_2(self):
        cotizado = src.cotizador.cotizar_seguro('Cuenca', 55, 'hombre', 'soltero', 'infarto', 3)
    ...
    def test_cotizador_10(self):
        ...
        self.assertEqual(cotizado,
                         "Solo se puede realizar la cotizacion para hasta 4 dependientes en linea. Por favor acerquese a la agencia y presente una solicitud.")
